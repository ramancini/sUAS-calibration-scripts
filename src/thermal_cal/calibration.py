...
class Calibrator:
    ...
    def calibrate_radiance(self,temperature, temperature_chamber,rsr_path, wavelength, emissivity=1, reflectivity=0):
        """
        ...
        if not result.empty:
            ...
            raise ValueError("Responsivity value not found for the specified wavelength") 
        

        numerator = ((emissivity * radiance) + (reflectivity * bg_radiance)) * relative_response
